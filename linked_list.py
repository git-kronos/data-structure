...
from abstracts import ABCLinkedList
...
if __name__ == "__main__":
    ...
    try:
        l_list.append_last('a')
        l_list.append_last('b')
        l_list.append_last('c')
        l_list.append_last('d')
        l_list.append_last('e')
        print(l_list.print_ll(), l_list.size())
